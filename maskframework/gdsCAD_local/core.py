...
The fundamental gdsCAD_local object is the Layout, which contains all the information
...
.. note::
    ...
    gdsCAD_local (based on gdspy) is released under the terms of the GNU GPL
...
class Boundary(ElementBase):
    ...
    Examples::
        ...
        triangle = gdsCAD_local.core.Boundary(triangle_pts)
        myCell.add(triangle)
    """
...
class Path(ElementBase):
    ...
    Examples::
        ...
        arrow = gdsCAD_local.core.Path(arrow_pts)
        myCell.add(arrow)
    """
    show=_show
...
class Layout(dict):
    ...
    by their name::
        l=gdsCAD_local.core.Layout('layout')
        l.add(top_cell)
...
class Cell(object):
    ...
    def add(self, element, *args, **kwargs):
        ...
        if isinstance(element, Cell):
            ...
            # AF I have overwritten this function to make it work with my library
            self._objects.append(element)
